function[name_true,name_pred,id_true,id_pred,name_conf,id_conf,name_stat,id_stat] = performanceNSal1(txt_path_name,txt_path_id,audio_path,noise)
...
for i=1:length(speakers)
    ...
    for k=(length(test_name)-2):(length(test_name))
        ...
        [Name,~] = WienerNoiseReduction(Name,fsn,fsn*0.4);
        [Id,~] = WienerNoiseReduction(Id,fsn,fsn*0.4);
